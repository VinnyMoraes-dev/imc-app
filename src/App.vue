<template>
  <h1 class="label-title">Cáculo do IMC</h1>
  ...
  <div class="div-imc">
    <span class="p-float-label">
      ...
      <label class="label2" for="input-weight">Peso</label>  
    </span>
  </div>
  ...
  <div class="div-imc">
    <span class="p-float-label">
      ...
      <label class="label2" for="input-height">Altura</label>  
    </span>
  </div>

  <div class="div-imc" v-if="!imc">
    <button-item label="Limpar" @click="clear"/>
    <button-item label="Calcular" @click="calculate" class="button-calculate"/>
  </div>

  <div v-if="imc">
    <p class="label-result">Seu IMC é: {{ imc }}</p>
    <p class="label-classification">A classificação do seu IMC é: {{ classification }}</p>
    <button-item label="Calcular Novamente" @click="clear"/>
  </div>
</template>
